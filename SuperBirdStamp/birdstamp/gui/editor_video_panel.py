...
class VideoExportWorker(QThread):
    ...
    def _prepare_jobs(self) -> list[VideoFrameJob]:
        return prepare_render_jobs(
            self._job_seeds, cancelled=self._cancel_event.is_set,
            progress=self.progressTextChanged.emit, metadata_loader=extract_many_with_xmp_priority,
        )
