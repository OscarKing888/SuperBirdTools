...
# Collect Torch/Ultralytics before Qt analysis as a defense-in-depth ordering.
# The build-only sitecustomize bootstrap is what protects every PyInstaller
...
superviewer_datas = [
    ...
    *collect_tree(SUPERVIEWER_ROOT / "images", "images"),
